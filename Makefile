...
CC      = arm-none-eabi-gcc -std=gnu99 -c -Wall -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -fmessage-length=0 -fno-exceptions -fno-builtin -ffunction-sections -fdata-sections -funsigned-char -MMD -fno-delete-null-pointer-checks -fomit-frame-pointer -O0 -g3 -DMBED_DEBUG -DMBED_TRAP_ERRORS_ENABLED=1 -mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -DMBED_ROM_START=0x8000000 -DMBED_ROM_SIZE=0x40000
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1533150356.95
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1533150356.95
...
tags: $(PROJECT).elf
	@cd ..; gtags
# 	cd ..; rm -f deptemp cscope_files
# 	@cd ..; find . -name "*.d" | xargs -n 1 ./locate_deps
# 	@cd ..; ./write_deps
#	@cd ..; mv cscope_files cscope.files
# 	@cd ..; echo "main.cpp" >> cscope.files
#	@cd ..; cscope -k cscope.out cscope.files
# 	@cd ..; find . -path "./TSL2561/*" -name "*.cpp" 	\
		-o -path "./TSL2561/*" -name "*.[ch]" 		\
		-o -path "./mbed-os/*" -name "*.cpp"		\
		-o -path "./mbed-os/*" -name "*.[ch]"		
